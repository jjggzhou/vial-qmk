...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [0] = LAYOUT(
    	MT(MOD_LALT,KC_ESC), KC_Q,    KC_W,    KC_E,    KC_R,    KC_T,    KC_DEL,  KC_F5,   KC_F2,        KC_Y,    KC_U,    KC_I,    KC_O,    KC_P,    MT(MOD_RALT,KC_BSLS),
    	MT(MOD_LCTL,KC_TAB), KC_A,    KC_S,    KC_D,    KC_F,    KC_G,                                    KC_H,    KC_J,    KC_K,    KC_L,    KC_SCLN, MT(MOD_LCTL,KC_QUOT),
    	KC_LSFT,             KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,                                    KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH, KC_LSFT,
		  	                 KC_LGUI, KC_LALT, LT(2, KC_DEL),   LT(1, KC_SPC), MO(1),       MO(1), LT(1, KC_ENT), LT(2,KC_BSPC),  KC_LBRC,  KC_RGUI,
      LGUI(KC_TAB), LCTL(LGUI(KC_RIGHT)), LCTL(LGUI(KC_LEFT)),
      LCTL(KC_PPLS), LCTL(KC_PMNS),
       KC_BTN1, KC_BTN1, KC_BTN2
  ),

	[1] = LAYOUT(
		KC_GRV,   KC_NO,   KC_NO,   KC_NO,   KC_NO,   KC_NO, KC_DEL,  KC_F5,   KC_F2,  KC_NO,   KC_NO,   KC_LBRC, KC_RBRC,   KC_MINS, KC_EQL,
		...
		KC_LSFT,   KC_6,    KC_7,    KC_8,    KC_9,    KC_0,   KC_NO,   KC_NO,   KC_NO,   KC_SCLN, KC_QUOT,  KC_LSFT,
                  KC_NO,   KC_NO, MO(3),    KC_NO,   KC_LSFT,  KC_LSFT,   KC_NO,   MO(3), KC_NO, KC_NO,
    KC_TRNS,
    KC_TRNS, KC_TRNS,
	...
	[2] = LAYOUT(
    KC_F1,   KC_F2,   KC_F3,    KC_F4,    KC_F5,   KC_F6, KC_DEL,  KC_F5,   KC_F2,    KC_F7,   KC_F8,  KC_F9,  KC_F10,   KC_F11,  KC_F12,
	...
	[3] = LAYOUT(
		RGB_VAI,  RGB_SAI,    RGB_HUI,    RGB_SPI,   RGB_MOD,    RGB_TOG, KC_DEL,  KC_F5,   KC_F2,  KC_NO,   KC_NO,   KC_NO,  QK_BOOT,   QK_CLEAR_EEPROM,   KC_NO,
    ...
    MT(MOD_LCTL,KC_TAB), KC_A,    KC_S,    KC_D,    KC_F,    KC_G,         KC_H,    KC_J,    KC_K,    KC_L,    KC_SCLN, MT(MOD_LCTL,KC_QUOT),
    KC_LSFT,             KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,         KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH, KC_LSFT,
		            KC_NO,   KC_NO,   U_M_ACL_4x,   U_M_ACL_2x,   KC_BTN1,   KC_BTN2, U_S_ACL_2x,   U_S_ACL_4x, KC_NO,   KC_NO,
    KC_TRNS,
    KC_TRNS, KC_TRNS,
    KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS
	),
